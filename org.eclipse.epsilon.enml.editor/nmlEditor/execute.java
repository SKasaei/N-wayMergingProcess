...
public class execute extends javax.swing.JFrame {
    ...
    public execute(INmlModule emlModule) {
    ...
    private void initComponents(INmlModule emlModule) {
     ...
     */
    private void btnRunActionPerformed(java.awt.event.ActionEvent evt , INmlModule emlModule , Choice choiceBase , Choice choiceTarget) {//GEN-FIRST:event_btnOpenChildJFrameActionPerformed
     ...
     */
    private void btnListModelsActionPerformed(java.awt.event.ActionEvent evt , INmlModule emlModule , Choice choiceBase , Choice choiceTarget) {//GEN-FIRST:event_btnListJFramesActionPerformed
    ...
    private void btnSetMetaActionPerformed(java.awt.event.ActionEvent evt , INmlModule emlModule , Choice choiceBase , Choice choiceTarget) {//GEN-FIRST:event_btnListJFramesActionPerformed
