...
*/
	 ...
	 * Create the frame.
	 */
	public DesignRational(IEmlModule emlModule ) {
		setResizable(false);
	...
	///////////////////////////////////////////////////////////////////
	 ...
	 public void DefineModelsName(IEmlModule emlModule)
	   {
	 ...
	 public Object[] createColumnTable()
	  ...
	  //columnNames = {"(#)", "Element", "Type", V0, V1, "..."};
	    ...
	    public Object[][] createDataTable(IEmlModule emlModule , Object[] columnNames)
		   {
	   ...
	   try {
	    ...
	    public void createTextArea_Report( IEmlModule emlModule , TextArea textArea_Report )
		   {
